        ...
        conversations.map((conv: Conversations) => {
          return (
            <div
              ...
              key={conv?._id}
              className="flex items-center gap-3 py-3 px-2 border transition-all rounded-full duration-300 border-transparent hover:border-stone-900 hover:bg-stone-900 cursor-pointer"
            >
